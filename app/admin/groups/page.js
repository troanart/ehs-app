...
export default function Groups() {
  ...
  const [selectedColors, setSelectedColors] = useState(() => {
    if (typeof window !== "undefined") {
      ...
      return getDefaultColors(); // Значение по умолчанию, если localStorage недоступен
    }
  });
